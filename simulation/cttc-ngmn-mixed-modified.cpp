...
//Modified BY Anna, Victor Gabriel and Lucas Vinicios
/**
 * \ingroup examples
...
main(int argc, char* argv[])
{
    ...
    uint32_t simTimeMs = 120000;
    Time appStartTime = MilliSeconds(400);
    std::string direction = "DL";
    bool uniformLambda = false;

    // topology
    uint16_t numOuterRings = 0;
    uint16_t uesPerGnb = 10; //Varies according to the scenario, the values ranged from 10 to 40
    ...
    bool logging = false;
    bool traces = true;
    bool useUdp = true; //Varies acoording to the scenario, the value are true or false
